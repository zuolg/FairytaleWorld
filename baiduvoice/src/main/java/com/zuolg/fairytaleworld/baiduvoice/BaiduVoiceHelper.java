package com.zuolg.fairytaleworld.baiduvoice;
...
public class BaiduVoiceHelper {
    ...
    public static void setNecessaryParams(Intent intent, String apiKey, String secret) {
        ...
        intent.putExtra(EXTRA_SOUND_START, com.zuolg.fairytaleworld.baiduvoice.R.raw.bdspeech_recognition_start);
        intent.putExtra(EXTRA_SOUND_END, com.zuolg.fairytaleworld.baiduvoice.R.raw.bdspeech_speech_end);
        intent.putExtra(EXTRA_SOUND_SUCCESS, com.zuolg.fairytaleworld.baiduvoice.R.raw.bdspeech_recognition_success);
        intent.putExtra(EXTRA_SOUND_ERROR, com.zuolg.fairytaleworld.baiduvoice.R.raw.bdspeech_recognition_error);
        intent.putExtra(EXTRA_SOUND_CANCEL, com.zuolg.fairytaleworld.baiduvoice.R.raw.bdspeech_recognition_cancel);
